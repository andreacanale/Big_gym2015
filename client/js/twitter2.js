...
*********************************************************************/
/*
This version has col-*-* integration, but it's useless since this module's css is already relative
...
"/").replace("T"," ").split("+")[0]),d=y(l,d);f[b].setAttribute("aria-label",d);if(a[b].innerText)if(z)f[b].innerText=d;else{var l=document.createElement("p"),I=document.createTextNode(d);l.appendChild(I);l.setAttribute("aria-label",d);f[b]=l}else f[b].textContent=d}d="";C?(r&&(p(a[b]),q&&p(g[b])),q&&(d+='<div class="user col-xs-2 col-sm-12">'+w(g[b].innerHTML)+"</div>"),d+='<p class="tweet col-xs-2 col-sm-12">'+w(a[b].innerHTML)+"</p>",v&&(d=G?d+('<p class="timePosted col-xs-2 col-sm-12"><a href="'+t[b]+'">'+f[b].getAttribute("aria-label")+"</a></p>"):
d+('<p class="timePosted col-xs-2 col-sm-12">'+f[b].getAttribute("aria-label")+"</p>"))):a[b].innerText?(q&&(d+='<p class="user col-xs-2 col-sm-12">'+g[b].innerText+"</p>"),d+='<p class="tweet col-xs-2 col-sm-12">'+a[b].innerText+"</p>",v&&(d+='<p class="timePosted col-xs-2 col-sm-12">'+f[b].innerText+"</p>")):(q&&(d+='<p class="user col-xs-2 col-sm-12">'+g[b].textContent+"</p>"),d+='<p class="tweet col-xs-2 col-sm-12">'+a[b].textContent+"</p>",v&&(d+='<p class="timePosted col-xs-2 col-sm-12">'+f[b].textContent+"</p>"));E&&(d+='<p class="interact col-xs-2 col-sm-12"><a href="https://twitter.com/intent/tweet?in_reply_to='+m[b]+'" class="twitter_reply_icon"'+
